...
function AgentClient({ appConfig, data }: EmbedFixedAgentClientProps) {
  console.log("=0000000000000000000000000000000 AgentClient data:", data);
  ...
  const { connectionDetails, refreshConnectionDetails, existingOrRefreshConnectionDetails } =
    useConnectionDetails(appConfig, data);
